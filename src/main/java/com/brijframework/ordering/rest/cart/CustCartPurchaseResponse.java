...
public class CustCartPurchaseResponse {
	private Long id;
	...
	private List<CustCartPurchaseItemResponse> custCartPurchaseItemList;
	...
	public List<CustCartPurchaseItemResponse> getCustCartPurchaseItemList() {
		return custCartPurchaseItemList;
	}

	public void setCustCartPurchaseItemList(List<CustCartPurchaseItemResponse> custCartPurchaseItemList) {
